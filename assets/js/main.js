const state = {
    ...
    values:{
        ...
        charsClassList: [
            ...
            ["why-running", "why-running.mp3", 0.01, 0.3], ["why-running-1", "why-running-1.mp3", 0.01, 0.4], ["what-wtf", "what-wtf.mp3", 0.01, 0.4],
            ["are-you-serious", "are-you-serious.mp3", 0.01, 0.6], ["click-nice", "click-nice.mp3", 0.01, 0.6], ["m-scott-no", "m-scott-no.mp3", 0.01, 0.4],
            ["nani", "nani.mp3", 0.01, 0.4], ["omg-uau", "omg-uau.mp3", 0.01, 0.6], ["zach-g", "zach-g.mp3", 0.01, 0.7],
        ],
        charsClassNow: null,
        charArrayIndex: 0,
    },
